...
| Principle | Key Focus | Primary Risk Mitigated |
|-----------|-----------|------------------------|
| **1. Tier Alignment & Generation Card** | Transparent reporting of generation process | Cherry-picking, result manipulation |
| **2. Data Provenance & Leakage Audit** | Strict data isolation and partitioning | Data contamination, inflated performance |
| **3. Baseline & Shortcut Audit** | Comparison with simple methods | Unjustified complexity, shortcut learning |
| **4. Uncertainty Quantification** | Confidence and calibration metrics | Overconfident predictions, misuse in high-stakes scenarios |
| **5. Downstream Biological Validity** | Task-relevant evaluation beyond reconstruction | Loss of biological signal, scientifically useless outputs |
| **6. Open Science & Living Guidelines** | Full reproducibility and transparency | Irreproducible research, lack of trust |
